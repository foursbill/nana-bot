...
const owo = JSON.parse(fs.readFileSync('./lib/riell.json'))
   ...
   // anticall auto block
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: "https://instagram.com/jamer.1140",
                            mediaType: 1,
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${namaowner}\nFN:${namaowner}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:rielbusinis8877@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://youtube.com/@rielbotzoffc2764\nitem3.X-ABLabel:Panel\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
