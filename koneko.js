...
newReply(`*「  NANA-ᴍᴅ ꜱᴄʀɪᴘᴛ  」*\n\n*YouTube:*\n*https://youtube.com/@rielbotzoffc2764*\n\n*please subscribe Chanel gua bre🙏🏻😅* 🍜 `)
        break
...
break
            ...
            case 'menu':
case 'help': {
    let anu =`Hello ${pushname}\nI Am ${namabot} Hallo, Kenalin saya adalah NANABOT, perangkat lunak otomatis yang melakukan tugas berulang melalui jaringan. Saya juga dapat mengikuti instruksi khusus untuk meniru perilaku manusia tetapi lebih cepat dan lebih akurat lo. Saya juga dapat berjalan secara independen tanpa intervensi manusia. melalui WhatsApp.
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "Nana-ᴍᴅ",
        thumbnailUrl: "https://telegra.ph/file/90eb8b0d9c1fe590c4aca.jpg",
...
let e = String(err)
conn.sendMessage("6281255642719@s.whatsapp.net", { text: "👋🏻 Hello developer, ada yang error nih! di bagian " + util.format(e), 
contextInfo:{
